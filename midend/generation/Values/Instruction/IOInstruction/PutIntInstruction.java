...
public class PutIntInstruction extends IoStreamInstruction {
    public PutIntInstruction(Value target) {
        super(new VarType(0), "PutIntDeclare", "io");
        addOperand(target);
    }
